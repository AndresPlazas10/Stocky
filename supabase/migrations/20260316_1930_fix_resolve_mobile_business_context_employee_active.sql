-- =====================================================
-- Fix resolve_mobile_business_context employee is_active nulls
-- Fecha: 2026-03-16
-- Objetivo:
--   1) Tratar employees.is_active NULL como activo
--   2) Evitar falsos negativos al resolver contexto móvil
-- =====================================================
...
IS 'Returns owner/employee business context for mobile, treating NULL employee is_active as true.';
