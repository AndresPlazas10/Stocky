-- =====================================================
-- FIX: quitar referencia a orders.created_at en RPCs de mesas
-- Fecha: 2026-08-15
-- Motivo: la migración 20260815_0100 usó
--   COALESCE(o.opened_at, o.created_at) y
--   COALESCE(o.updated_at, o.opened_at, o.created_at)
-- pero la tabla orders NO tiene columna created_at
-- ("column o.created_at does not exist" al ejecutar el RPC).
-- opened_at y updated_at sí existen.
-- =====================================================
    ...
    SELECT
      ...
      CASE
        ...
        ELSE jsonb_build_object(
          ...
          'updated_at', COALESCE(o.updated_at, o.opened_at)
        )
      END AS orders,
