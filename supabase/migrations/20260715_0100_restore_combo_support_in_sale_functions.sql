-- ============================================================
-- Restaurar soporte de combos en create_sale_complete y
-- create_split_sales_complete
-- Fecha: 2026-07-15
-- Problema:
--   La migración 20260521 sobrescribió ambas funciones con
--   versiones que solo manejan productos (sin combos).
-- Solución:
--   Reescribir ambas funciones combinando:
--   - Lógica de combos de 20260220_0900 (temp tables, validación
--     de combo_items, descuento de stock consolidado)
--   - Mejoras de 20260521 (limpieza de order_items al cerrar,
--     SET search_path = '')
-- ============================================================

-- -----------------------------------------------------------------
-- 1) create_sale_complete con soporte de combos
-- -----------------------------------------------------------------
...
BEGIN
  ...
  -- Cerrar orden y LIMPIAR order_items para no bloquear futuros deletes de producto
  IF p_order_id IS NOT NULL THEN
...
IS 'Crea venta completa con soporte de combos estructurados. Valida stock de productos internos de combos y descuenta inventario consolidado. Limpia order_items al cerrar orden.';

-- -----------------------------------------------------------------
-- 2) create_split_sales_complete con soporte de combos
-- -----------------------------------------------------------------
...
IS 'Crea múltiples ventas (split bill) con soporte de combos. Limpia order_items al cerrar orden.';
