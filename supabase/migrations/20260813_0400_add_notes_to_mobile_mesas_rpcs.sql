-- =====================================================
-- EXPONER orders.notes EN RPCs DE MESAS (MOBILE)
-- Fecha: 2026-08-13
-- Objetivo: que la app mobile reciba el comentario del
-- pedido (orders.notes) en el jsonb `orders` de las
-- mesas, tanto en la variante legacy como en la fast.
-- Basado en la última versión de ambos RPCs
-- (20260702_0000_fix_tables_column_references.sql).
-- =====================================================
...
IS 'Lista mesas por negocio con resumen de orden actual (incluye orders.notes para comentarios del pedido).';
...
IS 'Version optimizada de list_tables_with_order_summary para mobile (incluye orders.notes).';
