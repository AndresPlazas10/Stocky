...
import { Shield, FileText, AlertTriangle, CheckCircle2, Info, ArrowLeft, type LucideIcon } from 'lucide-react';
...
function Section({ number, title, icon: _Icon, color, children, highlighted = false }: SectionProps) {
