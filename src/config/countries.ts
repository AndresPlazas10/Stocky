...
export const US_TIMEZONES: TimezoneOption[] = [
  { value: 'America/New_York', label: 'Eastern (ET)', abbreviation: 'ET' },
  { value: 'America/Chicago', label: 'Central (CT)', abbreviation: 'CT' },
  { value: 'America/Denver', label: 'Mountain (MT)', abbreviation: 'MT' },
  { value: 'America/Los_Angeles', label: 'Pacific (PT)', abbreviation: 'PT' },
  { value: 'America/Anchorage', label: 'Alaska (AKT)', abbreviation: 'AKT' },
  { value: 'Pacific/Honolulu', label: 'Hawaii (HT)', abbreviation: 'HT' },
];
...
export const COUNTRIES: Record<string, CountryConfig> = {
  CO: {
    ...
    taxRate: 19,
    paymentMethods: ['cash', 'card', 'transfer', 'nequi', 'bancolombia', 'banco_bogota', 'nu', 'davivienda', 'daviplata']
  },
  EC: {
    code: 'EC',
    name: 'Ecuador',
