      ...
      <AnimatePresence>
        {showEditModal && editingProduct && (
          ...
          >
            ...
            >
              <div className="sticky top-0 bg-gradient-to-r from-gray-600 to-gray-700 text-white p-6 rounded-t-2xl flex items-center justify-between z-10">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white/20 rounded-lg">
              ...
              <form onSubmit={(e) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full h-11 px-4 border border-gray-300 rounded-xl focus:border-gray-500 focus:ring-gray-500 transition-all duration-300"
                    >
                      <option value="">Seleccionar categoría</option>
                      <option value="Platos">Platos</option>
                      <option value="Bebidas Alcohólicas">Bebidas Alcohólicas</option>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      disabled={formData.manage_stock === false}
                      className="h-11 rounded-xl border-gray-300 focus:border-gray-500 focus:ring-gray-500 disabled:bg-gray-100 disabled:text-gray-400"
                    />
                  </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="flex-1 h-12 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                        <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
