        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white/80">
              Gestión externa al runtime de Stocky
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-xl">
          ...
          <div className="text-sm text-gray-900">
            ...
            <p className="mt-1">
              Stocky no emite facturas electrónicas DIAN desde el runtime de la
              app. {` ${businessName}`} debe gestionar su facturación oficial
              directamente en su proveedor autorizado.
            </p>
          </div>
        </div>

        <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-900">
          Los comprobantes generados en Stocky son informativos y no reemplazan
