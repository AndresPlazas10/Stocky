...
import type { InputHTMLAttributes, SelectHTMLAttributes, TextareaHTMLAttributes, ElementType, ReactNode } from 'react';
import { motion } from 'framer-motion';
import { cn } from '@/lib/utils';

interface ModernButtonProps extends React.ComponentProps<typeof motion.button> {
