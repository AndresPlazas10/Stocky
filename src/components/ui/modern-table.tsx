...
export function ModernTable({ columns, data, onRowClick, loading, emptyMessage = "No hay datos para mostrar" }: ModernTableProps) {
  if (loading) {
    return (
...
export function ModernBadge({ children, variant = "default", className }: ModernBadgeProps) {
  const variants = {
...
interface ModernTableActionsProps extends HTMLAttributes<HTMLDivElement> {
  children?: ReactNode;
}

export function ModernTableActions({ children, className }: ModernTableActionsProps) {
  return (
...
interface ModernTableButtonProps extends HTMLAttributes<HTMLButtonElement> {
  onClick?: () => void;
  icon?: ElementType;
...
export function ModernTableButton({ onClick, icon: Icon, variant = "default", children, className }: ModernTableButtonProps) {
  const variants = {
