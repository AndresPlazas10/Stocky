...
function normalizeDetails(details: DetailItem[] | unknown[]) {
...
interface AnimatedStatusGlyphProps {
  type: string;
  Icon: ElementType;
  accentClass: string;
}

function AnimatedStatusGlyph({ type, Icon, accentClass }: AnimatedStatusGlyphProps) {
  if (type === 'success') {
    return (
      <motion.div
