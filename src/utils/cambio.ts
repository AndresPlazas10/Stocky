...
export const parseCopAmount = (value: unknown): number => {
...
export const calcularCambio = (total: number, pagado: unknown, currencyCode = 'COP'): CambioResult => {
  ...
  const breakdown: CambioBreakdown[] = [];
