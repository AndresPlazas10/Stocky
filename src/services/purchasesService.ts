...
function buildPurchasesListCacheKey({ businessId, filters = {} as PurchaseFilters, pagination = {} as PurchasePagination }: { businessId: string; filters?: PurchaseFilters; pagination?: PurchasePagination }) {
  return [
    'purchases',
    'list',
    businessId,
